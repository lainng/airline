...
<div class="bg-content">
    <div class="container pb-4">
        <div class="d-flex flex-column justify-content-start pt-5">
            ...
            <div class="row align-content-start col-auto p-4 white-box mt-2">
                <form method="get" action="${pageContext.request.contextPath}/controller" id="flightSearch" class="mt-2 mb-0">
